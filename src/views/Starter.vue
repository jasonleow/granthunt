                ...
                <div class="container shape-container d-flex" style="padding-top: 12rem !important;">
                    <div class="col px-0">
                        <div class="row row-grid justify-content-between align-items-center">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">The easiest way to hunt down that grant for your social impact project
                                    <!--<span>completed with examples</span>-->
                                </h1>
                                <p class="lead  text-white">Search for grants for charities and non-profits in the social service sector, using our chat bot or the search directory site. Currently only available in Singapore.</p>
                                <div class="btn-wrapper">
                                    ...
                                    <base-button tag="a"
                                                 href="https://www.messenger.com/t/gogranthunt"
                                                 class="mb-3 mb-sm-0"
                                                 type="white"
                ...
                <card gradient="primary"
                    ...
                    <div class="p-5">
                        <div class="row align-items-center">
                            <div class="col-lg-8">
                                <h3 class="text-white">Find your social impact grant now</h3>
                                <p class="lead text-white mt-3">Have a chat with our Grant Hunt bot on Facebook Messenger, and (s)he will get you started on getting funding for your impactful social service project.</p>
                            </div>
                            <div class="col-lg-3 ml-lg-auto">
                                <base-button tag="a" href="https://www.messenger.com/t/gogranthunt"
